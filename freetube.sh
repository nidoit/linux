#!/bin/bash
# FreeTube Installation Script
set -e

# Check if already installed
if pacman -Qi freetube-bin &>/dev/null; then
    echo "freetube-bin is already installed!"
    exit 0
fi
...
echo "freetube-bin installed successfully!"
